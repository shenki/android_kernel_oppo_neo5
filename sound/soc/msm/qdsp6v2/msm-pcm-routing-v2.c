...
static const struct snd_kcontrol_new tertiary_mi2s_rx_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_MULTIMEDIA9, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	 /* qcom add for refmic to speaker loopback,2014/1/28,next 3 line */
...
/* qcom add for refmic to speaker loopback,2014/1/28,next 4 line */
static const struct snd_kcontrol_new tert_mi2s_rx_port_mixer_controls[] = {
    ...
    MSM_BACKEND_DAI_SLIMBUS_0_TX, 1, 0, msm_routing_get_port_mixer,
    msm_routing_put_port_mixer),
    /*OPPO 2014-05-13 zhzhyon Add for FM to MI2S*/
    SOC_SINGLE_EXT("INTERNAL_FM_TX", MSM_BACKEND_DAI_TERTIARY_MI2S_RX,
    MSM_BACKEND_DAI_INT_FM_TX, 1, 0, msm_routing_get_port_mixer,
    msm_routing_put_port_mixer),
    /*OPPO 2014-05-13 zhzhyon Add end*/
};
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	/* qcom add for refmic to speaker loopback,2014/1/28,next 1 line */
    {"TERT_MI2S_RX Audio Mixer", "Voice Stub", "VOICE_STUB_DL"},
